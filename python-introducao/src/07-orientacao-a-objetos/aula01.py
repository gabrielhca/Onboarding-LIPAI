...
# calcular area e perimetro de um retângulo
# area = base * altura
# perimetro = 2 * (base + altura)
# estrutura para armazenar os valores necessários para os calculos


# solução usando programação procedural
retangulo1 = {
    "base": 10.0,
    "altura": 5.0
}
...
# classe representa um conceito/modelo
# a classe possui atributos (características): base e altura
# a classe possui métodos (comportamentos): calcular_area e calcular_perimetro
